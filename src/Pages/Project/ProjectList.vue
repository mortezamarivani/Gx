          ...
          <div class="panel-body" style="background-color:#f7f7f9">
            <div class="panel panel-warning" v-if="!ShowPanel">
              ...
              <div class="panel-heading">
                <div class="row">
                  <div class="col-md-6">
                    <h2 style="direction:ltr">Show all Project list</h2>
                  </div>
                  <div class="col-md-3">
                  ...
                  <form action="#">
                    <transition enter-active-class="animated fadeIn">
                      <div class="row FilterPanel" v-if="filterPanel">
                          ...
                          <table class="table table-hover">
                            <thead class="thead-dark">
                              <tr>
                                <th>
                                  <md-switch 
                                    v-model="ProjectNameSwitch"
                                    @change="AllfieldValueSwitch=false"
                                  >ProjectName</md-switch>
                                </th>
                                <th>
                                  <md-switch
                                    v-model="ProjectDescSwitch"
                                    @change="AllfieldValueSwitch=false"
                                  >ProjectDesc</md-switch>
                                </th>
                                <th>
                                  <md-switch
                        ...
                        <div class="col-md-10">
                          <md-field md-clearable v-if="ProjectNameSwitch && !AllfieldValueSwitch">
                            <label>ProjectName</label>
                            <md-input v-model="ProjectName" class="inputstyle"></md-input>
                          </md-field>
                          <md-field md-clearable v-if="ProjectDescSwitch && !AllfieldValueSwitch">
                            <label>ProjectDesc</label>
                            <md-input v-model="ProjectDesc" class="inputstyle"></md-input>
                          </md-field>
                  ...
                  <table class="table table-hover">
                    <thead class="thead-dark">
                      <tr class="row-fluid">
                       ...
                       <th scope="col" class="HeaderTableStyle">ProjectName</th>
                       <th scope="col" class="HeaderTableStyle">ProjectDesc</th>
                    ...
                    <tbody>
                      <tr v-for="(Project, index) in FilterdProjectList" :key="index">
                        <th scope="row">{{index + 1}}</th>
                        <th>{{ Project.projectID}}</th>
                        <td>{{ Project.projectName}}</td>
                        <td>{{ Project.projectDesc}}</td>
                        <td>{{ Project.position}}</td>
                        <td>{{ GetLanguge(Project.languge)}}</td>
                ...
                <nav aria-label="Page navigation">
                  <ul class="pagination">
                    ...
                    <span class="md-caption">
                      ...
                      Record:( {{currentPage * countPage - (countPage-1)}} - {{currentPage * countPage}} :{{GetAllProjectCount}} )
                    </span>
                  </ul>
                </nav>
              </div>
...
export default {
  data() {
    return {
      ...
      ProjectNameSwitch: false,
      ProjectDescSwitch: false,
      StatusSwitch: false,
  ...
  methods: {
    ...
    DisableFiltersObjects() {
      this.ProjectNameSwitch = false;
      this.ProjectDescSwitch = false;
  ...
  computed: {
    GetProjectByPageId() {
      return this.$store.getters.GetProjectByPageid;
    }, //
    ...
    GetTotalPage() {
      const Projectcount = Number(this.GetAllProjectCount);
      const pagecount = Number(this.countPage);
      const paging = Projectcount / pagecount;
    ...
    GetAllProjectCount() {
      return this.$store.getters.GetAllprojectCount;
    }, //
    ...
    FilterdProjectList() {
      ...
      if(this.GetProjectByPageId.projectID != undefined){
        return null;
      }

      return this.GetProjectByPageId.filter(Element => {
        if (
          this.ProjectNameSwitch == false &&
          this.ProjectDescSwitch == false &&
          this.StatusSwitch == false &&
        ...
        ) 
        {
          ...
          return (
            Element.projectName.toUpperCase().match(this.allFilterValue) ||
            Element.status
              .toString()
              .toUpperCase()
              .match(this.allFilterValue) ||
            Element.projectDesc.toUpperCase().match(this.allFilterValue) ||
          ...
          return Element;
        }else if (this.ProjectName =="" && this.Tools == "" && this.Institute==""
         && this.ProjectDesc==""  && this.Status=="" && this.Languge == ""){
           return Element;
        }

        return (
          Element.projectName.toUpperCase().match(this.GetFilterValue(this.ProjectName,'str')) ||
          Element.status.toString()
              .toUpperCase()
              .match(this.GetFilterValue(this.Status,'sts')) ||
          Element.projectDesc.trim().toUpperCase().match(this.GetFilterValue(this.ProjectDesc,'str'))||
          Element.tools.trim().toUpperCase().match(this.GetFilterValue(this.Tools,'str'))||
  ...
  created() {
    ...
    this.$store.dispatch("GetAllProjectCountFromService");
  } //created
}; //default
</script>
/*lang="scss"*/
